...
I attended [JupyterCon 2023](https://www.jupytercon.com/) in Paris last week. On Thursday, [Hamel Husain](https://hamel.dev/), myself, and J. J. Allaire (as teaching assistant) presented a two and a half hour tutorial on Writing, Documenting, Testing, and Distributing Python Packages with [nbdev](https://nbdev.fast.ai/) and [Quarto](https://quarto.org/).

I think it went well! The room was full and attendees engaged with great questions.

![](images/jupytercon-2023-tutorial.png){fig-align="center"}
